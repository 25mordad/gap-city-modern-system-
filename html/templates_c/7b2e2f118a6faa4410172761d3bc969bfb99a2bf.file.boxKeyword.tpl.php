<?php /* Smarty version Smarty-3.0.8, created on 2016-09-06 18:58:19
         compiled from "/var/www/gcms.dev/public_html/core/module/news/backend/tpl/news/edit/boxKeyword.tpl" */ ?>
<?php /*%%SmartyHeaderCode:53304754257ced283489ac2-28406755%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7b2e2f118a6faa4410172761d3bc969bfb99a2bf' => 
    array (
      0 => '/var/www/gcms.dev/public_html/core/module/news/backend/tpl/news/edit/boxKeyword.tpl',
      1 => 1447715352,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '53304754257ced283489ac2-28406755',
  'function' => 
  array (
  ),
        ...
        <p>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    var result = null;
                    var scriptUrl = "/gadmin/news/edit/<?php echo $_smarty_tpl->getVariable('page')->value->id;?>
...
;
                    ...
                    $("#demo-input-facebook-theme").tokenInput(document.URL+ "/AjaxController?controller=get_suggestions", {
                        prePopulate: result,
                        onAdd: function (item) {
                            $.post( "/gadmin/news/edit/<?php echo $_smarty_tpl->getVariable('page')->value->id;?>
...
/AjaxController?controller=del_keyword", { id: item.rel_id });
                        ...
                        onNew: function (item) {
                            $.post("/gadmin/page/news/<?php echo $_smarty_tpl->getVariable('page')->value->id;?>
