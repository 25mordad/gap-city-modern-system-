<?php /* Smarty version Smarty-3.0.8, created on 2016-09-29 15:41:20
         compiled from "/var/www/gcms.dev/public_html/core/module/shop/backend/tpl/shop/edit/price.tpl" */ ?>
<?php /*%%SmartyHeaderCode:98495414657ed04e8c9adc2-12251246%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd21893ee6893644bf9370accfd995edfef530635' => 
    array (
      0 => '/var/www/gcms.dev/public_html/core/module/shop/backend/tpl/shop/edit/price.tpl',
      1 => 1475151079,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '98495414657ed04e8c9adc2-12251246',
  'function' => 
  array (
  ),
...
" name="price" id="price" placeholder="Price" class="form-control" style="font-family: tahoma">
 ...
 ) + (document.getElementById("real_price").value*<?php echo $_smarty_tpl->getVariable('GCMS_SETTING')->value['shop']['eurorate'];?>
 *50/100 ) + (<?php echo $_smarty_tpl->getVariable('GCMS_SETTING')->value['shop']['eurorate'];?>
*5)  ;
...
" name="salse1_price" id="salse1_price" placeholder="Salse1 Price" class="form-control" style="font-family: tahoma">
 ...
 ) + (document.getElementById("buy_price").value*<?php echo $_smarty_tpl->getVariable('GCMS_SETTING')->value['shop']['eurorate'];?>
 *20/100 ) + (<?php echo $_smarty_tpl->getVariable('GCMS_SETTING')->value['shop']['eurorate'];?>
*5) ;
