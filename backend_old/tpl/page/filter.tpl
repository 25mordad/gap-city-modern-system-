              ...
              <div class="r_box" >
                ...
                <div class="mid">
                    <div class="txt">
                		...
                		<form method="get" action="page/?" class="uniForm" >
                    ...
                    {if $smarty.get.f_parent neq "all"}
                        <a href="page/?paging=1&search={$smarty.get.search}&f_parent=all&f_status={$smarty.get.f_status}"><div class="r_menu">
                            <span>حذف فیلتر صفحه مادر</span>
                            <img src="{$loct}/images/icon/pg_rm.png" />
                        </div></a>
                    {/if}
                        <a href="page/?paging=1&search={$smarty.get.search}&f_parent={$smarty.get.f_parent}&f_status=publish"><div class="r_menu" {if $smarty.get.f_status eq "publish"}id="act"{/if}>
                            <span>صفحات انتشاریافته</span>
                            <img src="{$loct}/images/icon/pg_ps.png" />
                        </div></a>                    
                        <a href="page/?paging=1&search={$smarty.get.search}&f_parent={$smarty.get.f_parent}&f_status=pending"><div class="r_menu" {if $smarty.get.f_status eq "pending"}id="act"{/if}>
                            <span>صفحات در دست بررسی</span>
                            <img src="{$loct}/images/icon/pg_pn.png" />
                        </div></a>
                    {if $smarty.get.f_status neq "all"}
                        <a href="page/?paging=1&search={$smarty.get.search}&f_parent={$smarty.get.f_parent}&f_status=all"><div class="r_menu">
