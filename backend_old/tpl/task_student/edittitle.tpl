...
<div class="box">
<div class="top">
<div class="title icon_info">عنوان تکلیف</div>
</div>
<div class="mid">
<div class="txt">
<div
...
>
<form
	action="task_student/edittitle/{$show_task_student->id} "
	method="post"
>
<h1>ویرایش عنوان تکلیف</h1>
<p></p>
<label for="pg_title">عنوان تکلیف <span
	class="small"
></span> </label> <input
	type="text"
	name="pg_title"
	id="pg_title"
	value="{$show_task_student->pg_title}"
/> <input
	type="submit"
	value="ویرایش"
	name="edit"
