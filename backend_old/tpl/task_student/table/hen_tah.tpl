<a href="/gadmin/task_student/show_table?id={$smarty.get.id}">جدول دروس کاربر {showusername_name id=$smarty.get.id}</a> | <h1>هندسه تحليلي</h1> <br /><br />
...
['name'=>"خط و صفحه " ],
['name'=>"مقاطع مخروطي" ],
['name'=>"ماتريس و دترمينان" ],
['name'=>"دستگاه معادلات خطي " ]
]}
<table >
    <tbody>
        <tr>
        ...
        {section name=dars start=1 loop=5 step=1}
           <tr class="htover">
                <td width="91" valign="top">
