<a href="/gadmin/task_student/show_table?id={$smarty.get.id}">جدول دروس کاربر {showusername_name id=$smarty.get.id}</a> | <h1>زمين شناسي سوم</h1> <br /><br />
...
<table >
    <tbody>
        ...
        {section name=dars start=1 loop=10 step=1}
           <tr class="htover">
                <td width="91" valign="top">
