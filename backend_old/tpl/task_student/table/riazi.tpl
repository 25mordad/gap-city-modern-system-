<a href="/gadmin/task_student/show_table?id={$smarty.get.id}">جدول دروس کاربر {showusername_name id=$smarty.get.id}</a> | <h1>رياضي </h1> <br /><br />
...
['name'=>"بردار" ],
['name'=>"آمار" ],
['name'=>"آناليز و احتمال" ],
['name'=>"دستگاه معالات خطي" ],
['name'=>"توابع نمايي و لگاريتمي" ],
['name'=>"مشتق" ],
['name'=>"کاربرد مشتق" ],
['name'=>"مقاطع مخروطي" ],
['name'=>"انتگرال" ],
['name'=>"استدلال و فيثاغورث" ],
['name'=>"تشابه" ],
['name'=>"هندسه فضايي " ]
]} 
<table >
