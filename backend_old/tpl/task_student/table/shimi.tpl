<a href="/gadmin/task_student/show_table?id={$smarty.get.id}">جدول دروس کاربر {showusername_name id=$smarty.get.id}</a> | <h1>شيمي  </h1> <br /><br />
...
['name'=>"الکتروشيمي" ],
['name'=>"استوکيومتري" ],
['name'=>"ترموديناميک شيميايي" ],
['name'=>"محلول ها" ],
['name'=>"ساختار اتم" ],
['name'=>"خواص تناوبي عناصر" ],
['name'=>"ترکيبات يوني" ],
['name'=>"ترکيبات کووالانسي" ],
['name'=>"کربن و ترکيب هاي آن " ]
]} 
<table >
    <tbody>
        <tr>
        ...
        {section name=dars start=1 loop=13 step=1}
           <tr class="htover">
                <td width="91" valign="top">
