<a href="/gadmin/task_student/show_table?id={$smarty.get.id}">جدول دروس کاربر {showusername_name id=$smarty.get.id}</a> | <h1>ادبیات 3</h1> <br /><br />
...
<table >
    <tbody>
        ...
        {section name=dars start=1 loop=24 step=1}
           <tr class="htover">
                <td width="91" valign="top">
