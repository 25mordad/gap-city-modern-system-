    ...
    <div class="box">
        ...
        <div class="mid">
            <div class="txt">
                ...
                <form action="link/newtitle" method="post" >
                <h1>تعریف عنوان گروه پیوند</h1>
                <p></p>
                
                <label for="pg_title">عنوان گروه پیوند
                <span class="small"></span>
                </label>
               <input type="text" name="pg_title" id="pg_title"  />
                                  
                   
                <input type="submit" value="ایجاد" name="new" />
