    ...
    label.error { font-family: tahoma; font-size: 9px; margin: -10px 10px 0 0; color: red; }
            ...
            <div class="login ">
                ...
                <script>
                  ...
                  {/literal}
                    <form method="post" action="/login/{$redirect}" class="login_form" id="loginform">
						...
						<input type="hidden" name="redirect" value="{$smarty.get.redirect}" />
						{/if}
						
                        <input type="submit" name="submit" value="ورود"  />
                        <div class="clear"></div>
                    </form>
                    <a href="/forgot"><span>کلمه عبور خود را فراموش کرده‌ام</span></a>
                    <div class="clear"></div>                    
                </div>
                <div class="clear"></div>
            </div>
