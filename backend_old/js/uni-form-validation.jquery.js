...
jQuery.fn.uniform.language = {
    ...
    submit_msg    : 'لطفا در پر کردن فرم دقت کنید',
    submit_help   : 'به خطاهای مشخص شده در پایین توجه کنید',
