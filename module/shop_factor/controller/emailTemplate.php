<?php
function emailTemp($bodyStatus,$bodyInfo,$bodyTransaction){
	$htm = '
...
<body class="body" style="padding:0; margin:0; display:block; background:#ffffff; -webkit-text-size-adjust:none;direction:rtl" bgcolor="#ffffff">
            ...
            <table cellspacing="0" cellpadding="0" width="600" class="w320">
              <tr>
                <td valign="top" class="mobile-block mobile-no-padding-bottom mobile-center" width="270" style="background:#1f1f1f;padding:10px 10px 10px 20px;">
                  <a href="http://'.$_SERVER['HTTP_HOST'].'" style="text-decoration:none;">
                    <img src="http://'.$_SERVER['HTTP_HOST'].'/uploads/source/emailtemplate/logo.png?display=loginEmail" width="220" />
                  </a>
                </td>
                  ...
                  <table cellspacing="0" cellpadding="0" width="100%">
                    <tr>
                      <td align="right" valign="bottom" style="padding-bottom:0; vertical-align:bottom;">
                        <img  style="vertical-align:bottom;" src="http://'.$_SERVER['HTTP_HOST'].'/uploads/source/emailtemplate/clip.gif"  width="174" height="294" />
                      </td>
                    </tr>
                  </table>
                </td>
