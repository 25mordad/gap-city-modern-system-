...
<div class="box box-solid box-info">
    ...
    <div class="box-body">
        ...
        <div class="row" >
            <div class="col-md-6" >
                <a href="/news/show/{$page->id}/{changetoplus title =$page->pg_title}" class="text-aqua "  target="_blank"  ><i class="glyphicon glyphicon-new-window fontSize9" ></i>
                    <small class="fontSize9">لینک خبر در سایت</small></a>
            </div>
            <div class="col-md-6" >
                <a href="/gadmin/menu/new?title={$page->pg_title|truncate:35:"":true}&link=/news/show/{$page->id}/{changetoplus title =$page->pg_title}" class="text-light "  ><i class="glyphicon glyphicon glyphicon-list " ></i>
