...
<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        ...
        <script type="text/javascript">
            var myDropzone = new Dropzone("div#IndexPagePic", { url:"/gadmin/news/editgroup/{$page->id}/AjaxController?controller=UplImgInx&part=newsgroup&id={$page->id}&type=newsgroup"})
