<div class="box box-primary">
    ...
    <div class="box-body no-padding">
        ...
        <div class="row" >
            {foreach $news_list as $page}
                <div class="col-md-6 " >
                    <!-- Warning box -->
                    <div class="box box-info">
                        <div class="box-header">
                            <h3 class="box-title">
                                <a href="/gadmin/news/edit/{$page->id}" >
                            ...
                            <div class="box-tools pull-left">
                                ...
                                {/if}
                                <button class="btn btn-xs btn-info" data-toggle="tooltip" data-placement="top" onclick="location.href='/gadmin/news/edit/{$page->id}'" title=" ویرایش ">
                        ...
                        <div class="box-body GCMSblock">
                            <p>
                                <img src="{get_last_image id=$page->id  type="news" thumb="thumb/" class="indx" source="true" }" class="img-thumbnail pull-left" width="115" >
                                {if $page->parent_id}
                                    <a href="/gadmin/news/editgroup/{$page->parent_id}" >  <span class="text-red " data-toggle="tooltip" data-placement="left" title=" گروه خبری والد  " >{showtitle id=$page->parent_id chagetoplus="false"  } </span></a>
