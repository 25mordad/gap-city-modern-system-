...
<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        ...
        <script type="text/javascript">
            var myDropzone = new Dropzone("div#IndexPagePic", { url:"/gadmin/product/edit/{$product->id}/AjaxController?controller=UplImgInx&part=product&id={$product->id}&type=product"})
