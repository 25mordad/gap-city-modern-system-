<div class="wrapper" >
	...
	<div class="right _765 ">
              ...
              <div class="l_box" >
                <div class="top">
                    <div class="title right">لیست گالری‌های صوت</div>
                    <img src="/core/module/sound/backend/images/sound.png" />
                    <div class="clear"></div>
                </div>
                <div class="mid">
                    <div class="txt">
	                   ...
	                   'close' => "غیر فعال" 
	                    ...
	                    <div class="list" id="tooltip">
                            <div class="top">
                                <span style="width: 450px;">عنوان گالری صوت</span>
                            ...
                            <div class="row_1">
                                ...
                                <span style="width: 50px;" class="last">
                                	<a href="sound/del/{$sound->id}" title="گالری صوت {$sound->pg_title} حذف شود؟"  class="confirm_dialog" ><div class="icon del" ></div></a>
                                </span>
                                <div class="clear"></div>
                            </div>
                            {/foreach}
