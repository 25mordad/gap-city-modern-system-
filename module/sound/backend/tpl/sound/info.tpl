...
{/if}
              ...
              <div class="r_box" >
                <div class="top">
                    <div class="title right">اطلاعات گالری صوت</div>
		                ...
		                {if $action eq "edit"}
	                		...
	                		{/if}
		                		...
		                		{if $sound->pg_status neq "delete"}
		                			<a href="sound/del/{$sound->id}" title="گالری صوت {$sound->pg_title} حذف شود؟"  class="del_btn confirm_del" >حذف گالری صوت</a>
		                		{else}
		                			<a href="sound/undel/{$sound->id}" title="گالری صوت {$sound->pg_title} بازیابی شود؟"  class="del_btn confirm_del" >بازیابی گالری صوت</a>
		                		{/if}
		                		</p>
