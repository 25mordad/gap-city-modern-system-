...
{/if}
              ...
              <div class="r_box" >
                <div class="top">
                    <div class="title right">{$title} گالری عکس</div>
                ...
                <div class="mid">
                    ...
                    {if $gallery->pg_status neq "delete"}
                    	<div class="ctrlHolder">
                              <p class="label">
                                <em>*</em>وضعیت گالری عکس
                              </p>
			                    {$pg_status_radio = [['name'=>"در دست بررسی" , 'value' => "pending"],['name' => "status_button_publish" , 'value' => "publish"]]}
			                    {radioTagGenerator info = $pg_status_radio radioName = "pg_status" ul="true" class="required" default="{if isset($gallery)}{$gallery->pg_status}{/if}"}
                              <p class="formHint"></p>
                    	</div>
                    	{if $GCMS_MODULE['user'] eq "active"}
                    	<div class="ctrlHolder">
                              <p class="label">
                                <em>*</em>نمایش گالری عکس
                              </p>
			                    {$pg_content_radio = [['name'=>"مخصوص اعضا" , 'value' => "user"],['name' => "نمایش عمومی" , 'value' => "public"]]}
			                    {radioTagGenerator info = $pg_content_radio radioName = "pg_content" ul="true" class="required" default="{if isset($gallery)}{$gallery->pg_content}{/if}"}
                              <p class="formHint"></p>
                    	</div>
		    			{else}
                    	...
                    	<div class="ctrlHolder">
                              <p class="label">
				                ...
				                {radioTagGenerator info = $comment_status_radio radioName = "comment_status" ul="true" class="required" default="{if isset($gallery)}{$gallery->comment_status}{/if}"}
                              <p class="formHint"></p>
                    	</div>
