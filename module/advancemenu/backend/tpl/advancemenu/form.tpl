...
{/if}
              ...
              <div class="l_box" >
                ...
                <div class="mid">
                    <div class="txt">
					<form action="advancemenu/{$action}{if isset($menu)}/{$menu->id}{/if}" method="post" class="uniForm">
					<fieldset>
                            
                            <div class="ctrlHolder">
                              <label for="group"><em>*</em>گروه منو</label>
                              {$group_select = [['name'=>"منوی اصلی",'value'=>"maingroup"],['name'=>"منوی فرعی ۱",'value'=>"fgroup1"],['name'=>"منوی فرعی ۲",'value'=>"fgroup2"],['name'=>"منوی فرعی ۳",'value'=>"fgroup3"]]}
                              <select name="group" id="group" class="selectInput required">
				                <option value="" selected="selected">-- @@Choose@@ --</option>
				                {selectTagGenerator info= $group_select default= $menu->group }
                              </select>
                              <p class="formHint"></p>
                            </div>
