...
<div class="box box-solid box-info">
    ...
    <div class="box-body">
        ...
        <div class="row" >
            <div class="col-md-6" >
                <a href="/shop/show/{$product->id}/{changetoplus title =$product->fa_title}+{changetoplus title =$product->en_title}" class="text-aqua "  target="_blank"  ><i class="glyphicon glyphicon-new-window fontSize9" ></i>
            ...
            <div class="col-md-6" >
                <a href="/gadmin/shop/instagram/{$product->id}" class="text-light "  ><i class="glyphicon glyphicon-picture " ></i>
