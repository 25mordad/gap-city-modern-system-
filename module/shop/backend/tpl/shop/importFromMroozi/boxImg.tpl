...
<div class="box box-solid box-primary">
    ...
    <div class="box-body">
        ...
        <script type="text/javascript">
            var myDropzone = new Dropzone("div#IndexPagePic", { url:"/gadmin/shop/edit/{$product->id}/AjaxController?controller=UplImgInx&part=shop&id={$product->id}&type=shop"})
        ...
        {foreach $pageImg as $pgIm}
            <div class="col-md-3" >
                ...
                <a href="?delImgInx={$pgIm->id}&relId={$pgIm->rel_id}"  >
                    <span class="badge bg-red"  >حذف</span>
                </a>
                <a href="?defaultPhoto={$pgIm->im_path}{$pgIm->im_name}"  >
