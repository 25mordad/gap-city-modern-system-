<div class="col-md-12" >
	...
	<div class="row" style="font-family: tahoma" >
		...
		<div class="form-group">
		    ...
		    <input type="text" class="form-control" name="refrence" value="{$reference[0]}" id="refrence"  placeholder="refrence">
		</div>
		...
		<script>
		$.getJSON('https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160910T231549Z.d3c0379676298079.04f16747b8f231b3dd6122ad85ef9074a8950f58&lang=en-fa&text={trim(str_replace("Details","",$headlines[0]))}', function(data) {
			document.getElementById("fa_title").value = data.text;
		});
		
		$.getJSON('https://translate.yandex.net/api/v1.5/tr.json/translate?key=trnsl.1.1.20160910T231549Z.d3c0379676298079.04f16747b8f231b3dd6122ad85ef9074a8950f58&lang=en-fa&text={trim($description[0])}', function(data) {
		...
		<div class="form-group">
		    ...
		    <input type="text" class="form-control" name="en_title" style="direction: ltr;" id="en_title" value="{trim(str_replace("Details","",$headlines[0]))}" placeholder="en_title">
		</div>
