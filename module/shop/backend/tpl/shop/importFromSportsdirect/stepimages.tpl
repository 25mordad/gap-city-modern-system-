<div class="col-md-12" >
	...
	<div id="answersImage" style="margin: 5px;padding: 5px;background: #ffccff;position:fixed; top:20%; left:0;width:40%; height: 200px;overflow: auto;"></div>
		{foreach $allImages as $img}
			<img width="100"  src="{$img->href}" onclick="add_image('{$img->href}');show_image();"><br>
			<span onclick="add_image('{$img->href}');show_image();" style="background:blue;cursor:pointer" >{$img->href}</span><br>  
		{/foreach}
		<script >
