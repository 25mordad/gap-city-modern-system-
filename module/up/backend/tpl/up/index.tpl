<div class="wrapper" >
	<div class="right _255 ">
		...
		<!-- / change Template Directory and show search  -->
		{include file="tpl/up/filter.tpl"}              
	</div>    
	<div class="right _765 ">
              <!-- _LBOX_ -->
              <div class="l_box" >
                <div class="top">
                    <div class="title right">لیست صفحات کاربران</div>
	                   ...
	                   'close' => "غیر فعال" 
	                    ...
	                    <div class="list" id="tooltip">
                            ...
                            <div class="row_1">
                                ...
                                <span style="width: 60px;"><a href="up/edit/{$page->id}"><div class="icon edit" ></div></a></span>
                                <span style="width: 60px;" class="last">
                                	<a href="up/del/{$page->id}/?paging={$smarty.get.paging}&search={$smarty.get.search}&f_parent={$smarty.get.f_parent}&f_status={$smarty.get.f_status}" 
