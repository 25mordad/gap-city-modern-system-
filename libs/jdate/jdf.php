...
//added by dahdash
function shamsi_to_miladi($shamsi)
{
	list($jyear, $jmonth, $jday) = preg_split ( '/-/', $shamsi );
	list( $year, $month, $day ) = jalali_to_gregorian($jyear, $jmonth, $jday);
	$miladi=$year."-".$month."-".$day;
	return $miladi;
}
function miladi_to_shamsi($miladi)
{
	list($year, $month, $day) = preg_split ( '/-/', $miladi );
	list($jyear, $jmonth, $jday) = gregorian_to_jalali($year, $month, $day);
	$shamsi=$jyear."-".$jmonth."-".$jday;
	return $shamsi;
}
